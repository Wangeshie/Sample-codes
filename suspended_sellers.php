...
<div class="container-fluid">
  <center> <h4>Suspended Sellers</h4> </center>
...
<?php
  $result=mysqli_query($conn,"SELECT * FROM company where status=3");
  $i=0;
...
<tr>
  ...
  <td> Approved </td>
   <td><a href="more_details3.php?id=<?php echo $row['company_id'] ?>" >More Details </a> </td>
