...
<head>
    <title>Unapproved sellers</title>
    <meta charset="utf-8">
...
<div class="container-fluid">
  <center> <h4>Unapproved Sellers</h4> </center>
...
<?php
  $result=mysqli_query($conn,"SELECT * FROM company where status=0");
  $i=0;
...
<tr>
  ...
  <td> Unapproved </td>
   <td><a href="more_details2.php?id=<?php echo $row['company_id'] ?>" >More Details </a> </td>
